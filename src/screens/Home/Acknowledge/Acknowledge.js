...
export default function Acknowledge() {
    ...
    const categories = ['Open', 'On Hold', 'Work Done', 'In Progress'];
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerText}>Acknowledge Issue</Text>
            </View>
            ...
            <ScrollView contentContainerStyle={styles.form}>
                        ...
                        <>
                            ...
                            >
                                <Text style={styles.dropdownText}>
                                    {selectedCategory || 'Change Status'}
                                </Text>
                ...
                <TouchableOpacity style={styles.submitButton} onPress={handleSubmit(onSubmit)}>
                    <Text style={styles.submitText}>Acknowledge</Text>
                </TouchableOpacity>
            </ScrollView>
